    ...
    <>
      <Row>
        ...
        <Col span={6} style={{display: "flex", justifyContent: "flex-end"}}>
          <span>
            <Text strong>
              Operating Mode: {getOperationMode()} {updateOperationModeButton()}
            </Text>
          </span>
        </Col>
      ...
      <div style={{marginTop: 10}}>
        <Row>
          ...
          <Col span={6}>
            <KikobaInitialSharesComponent kikoba={kikoba} onUpdate={onUpdate} />
          </Col>
          <Col span={6}>
      ...
      >
        <UpgradingKikobaAccountComponent kikoba={kikoba} onUpdate={() => {}} />
      </Modal>
                    ...
                    <>
                      <Row>
                        ...
                        >
                          ...
                          <Switch
                            disabled={kikoba?.paymentMode === "full_digital"}
                            defaultChecked
                    ...
                    <>
                      <Row>
                        ...
                        >
                          ...
                          <Switch
                            disabled={kikoba?.paymentMode === "semi_digital"}
                            defaultChecked
